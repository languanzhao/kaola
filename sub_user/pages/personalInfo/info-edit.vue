<template>
	<view class="info-edit">
		...
		<view class="part">
			...
			<!-- <view class="item" @click="schoolChoose">
				<view class="title">
					<text class="must">*</text>
					毕业学校
				</view>
			...
			<view class="item lastNoBottom" @click="addressClick">
				...
				<view class="rightPart">
					<view class="address">
						<text v-if='info.koala.contact_province'>{{info.koala.contact_province}}</text>
						<text v-if='info.koala.contact_city'>{{info.koala.contact_city}}</text>
						<text v-if='info.koala.contact_district'>{{info.koala.contact_district}}</text>
						<text v-if='info.koala.contact_address'>{{info.koala.contact_address}}</text>
						<text v-if="!info.koala.contact_province">请选择通讯地址</text>
					</view>
					<view class="iconfont icon-leftArrow"></view>
				</view>
			</view>
		...
		<!-- <view class="part">
			<view class="item">
				...
				<view class="rightPart" @click="jumpForget">
					<view class="address">{{PWState}}</view>
					<view class="iconfont icon-leftArrow"></view>
				</view>
			</view>
		</view> -->
