<template>
	<view class="apply">
		...
		<view class="schoolInfo module">
			<school-card :info='schoolInfo.sInfo'></school-card>
		</view>
		<view class="schoolInfo module">
			<view class="schoolInfo-bottom">
				<view class="item" @click="chooseClick('level')">
					<view class="title">报读层次</view>
					<view class="right">
						{{levelObj.value ? levelObj.name : '未填选'}}
		...
		<uni-popup ref='uniPopupPlan'>
			<view class="uniPopup-toast">
				...
				<view class="uniPopup-summary">凡是在线上报名且成功入学者，在满足条件享受国家助学金的基础上，还可以享受平台助学计划。（对于同一院校，通过其他渠道报名过，再在本平台报名的，不能享受平台助学计划）</view>
